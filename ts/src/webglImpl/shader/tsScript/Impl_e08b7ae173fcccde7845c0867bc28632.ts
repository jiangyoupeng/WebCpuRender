...
export class Impl_e08b7ae173fcccde7845c0867bc28632 extends FragShaderHandle {
    ...
    frag(): Vec4Data {
        let forFragTest: Vec4Data[] = [vec4(), vec4(), vec4(), vec4()]
        glSet_V4_V4((<any>forFragTest)[int_N(0).v], vec4_N(int_N(1)))
        ...
        glSet_V2_V2(s.position.out_xy, vec2_N_N(float_N(0.1), float_N(0.5)))
        let s1: StandardSurface = new StandardSurface()
        glSet_Struct_Struct(s1, s)
        glSet_V2_V2(s1.position.out_xy, vec2_N_N(int_N(0), int_N(0)))
        ...
        glSet_V4_V4(asd.out_xyzw, vec4_N_N_N_N(int_N(1), int_N(1), int_N(1), int_N(1)))
        ...
        glSet_V4_V4(matrix4Test, (<any>matrix4)[getOutValueKeyByIndex(int_N(0))])
        glSet_N_N(matrix4Test.out_x, float_N(0))
        glSet_N_N(matrix4Test.out_y, float_N(0))
        glSet_N_N(matrix4Test.out_z, float_N(0))
        glSet_N_N(matrix4Test.out_w, float_N(0))
        ...
        glSet_N_N(color.out_x, float_N(1))
        glSet_N_N(color.out_y, float_N(1))
        glSet_N_N(color.out_z, float_N(1))
        glSet_N_N(color.out_w, float_N(1))
