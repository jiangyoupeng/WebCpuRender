...
export class Impl_51be3ce9f0b7d7d460ec0b033a932277 extends FragShaderHandle {
        ...
        for (let i: IntData = int_N(0); glIsLess_N_N(i, LIGHTS_PER_PASS); glAfterAddSelf_N(i)) {
            ...
            if (glIsMore_N_N(float_N(this.uniformData.cc_lightPos[i.v].w), float_N(0.0))) {
                ...
                glSet_V4_V4(shadowPos, __shadowPos__)
                {
                    ...
                    glSet_V4_V4(pos, vec4_V3_N(projWorldPos.xyz, float_N(shadowPos.w)))
                    if (glIsMore_N_N(pcf, float_N(3.0))) {
                        glSet_N_N(shadowAttenuation, this.CCGetDirLightShadowFactorX25_V4_V3(pos, s.position))
                    } else if (glIsMore_N_N(pcf, float_N(2.0))) {
                        glSet_N_N(shadowAttenuation, this.CCGetDirLightShadowFactorX9_V4_V3(pos, s.position))
                    } else if (glIsMore_N_N(pcf, float_N(1.0))) {
                        glSet_N_N(shadowAttenuation, this.CCGetDirLightShadowFactorX5_V4_V3(pos, s.position))
                    } else glSet_N_N(shadowAttenuation, this.CCGetDirLightShadowFactorX1_V4_V3(pos, s.position))

                    glMulSet_V3_N(lightColor, glSub_N_N(float_N(1.0), shadowAttenuation))
                }
            }
            glAddSet_V3_V3(
                finalColor,
