...
export class Impl_de9902504d1a001521d20b52629b3d2e extends VertShaderHandle {
    ...
    vert(): Vec4Data {
        ...
        glSet_V3_V3(this.varyingData.v_normal, glMul_M4_V4(matWorldIT, vec4_V3_N(In.normal, float_N(0.0))).xyz)
