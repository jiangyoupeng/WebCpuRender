...
class VaryingDataImpl extends VaryingData {
    ...
    v_tangent: Vec3Data = new Vec3Data()
    v_bitangent: Vec3Data = new Vec3Data()
    ...
    dataKeys: Map<string, any> = new Map([
        ...
        ["v_tangent", cpuRenderingContext.cachGameGl.FLOAT_VEC3],
        ["v_bitangent", cpuRenderingContext.cachGameGl.FLOAT_VEC3],
    ...
    copy(varying: VaryingDataImpl) {
        ...
        glSet_V3_V3(varying.v_tangent, this.v_tangent)
        glSet_V3_V3(varying.v_bitangent, this.v_bitangent)
...
export class Impl_ce147167814c86f0cf890559cea6059e extends VertShaderHandle {
    ...
    vert(): Vec4Data {
        ...
        glSet_V3_V3(this.varyingData.v_tangent, normalize_V3(glMul_M4_V4(matWorld, vec4_V3_N(In.tangent.xyz, float_N(0.0))).xyz))
        glSet_V3_V3(
            this.varyingData.v_bitangent,
            glMul_V3_N(cross_V3_V3(this.varyingData.v_normal, this.varyingData.v_tangent), float_N(In.tangent.w))
        )
        ...
        glSet_N_N(this.varyingData.v_fog_factor, this.LinearFog_V4(pos))
        glSet_V4_V4(this.varyingData.v_shadowPos, glMul_M4_V4(this.uniformData.cc_matLightViewProj, pos))
        return glMul_M4_V4(glMul_M4_M4(this.uniformData.cc_matProj, glMul_M4_M4(this.uniformData.cc_matView, matWorld)), In.position)
    }
    main(): void {
