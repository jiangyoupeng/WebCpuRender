...
class UniformDataImpl implements UniformData {
    cc_matView: Mat4Data = null!
    cc_matProj: Mat4Data = null!
    cc_cameraPos: Vec4Data = null!
    cc_fogBase: Vec4Data = null!
    cc_fogAdd: Vec4Data = null!
    cc_matWorld: Mat4Data = null!
    dataKeys: Map<string, any> = new Map([
...
export class Impl_82c78a58e4c18fc91a97ecd22243a6f6 extends VertShaderHandle {
    ...
    vert(): Vec4Data {
        ...
        glSet_N_N(this.varyingData.v_fog_factor, this.LinearFog_V4(glMul_M4_V4(matWorld, position)))
        return glMul_M4_V4(glMul_M4_M4(this.uniformData.cc_matProj, glMul_M4_M4(this.uniformData.cc_matView, matWorld)), position)
    }
    main(): void {
