...
export class Impl_33a77d1aed98625a3b24fc22a6b067e6 extends FragShaderHandle {
    ...
    CCToonShading_ToonSurface(__s__: ToonSurface): Vec4Data {
        ...
        glSet_N_N(NL, glAdd_N_N(glMul_N_N(float_N(0.5), dot_V3_V3(N, L)), float_N(0.5)))
        let NH: FloatData = float()
        glSet_N_N(NH, glAdd_N_N(glMul_N_N(float_N(0.5), dot_V3_V3(normalize_V3(glAdd_V3_V3(V, L)), N)), float_N(0.5)))
        let lightColor: Vec3Data = vec3()
        glSet_V3_V3(
            lightColor,
            glMul_V3_N(glMul_V3_N(this.uniformData.cc_mainLitColor.xyz, float_N(this.uniformData.cc_mainLitColor.w)), s.baseStep)
        )
        ...
        glSet_V3_V3(
            ...
            mix_V3_V3_N(
                ...
                s.shade2,
                clamp_N_N_N(
                    glAdd_N_N(float_N(1.0), glDiv_N_N(glSub_N_N(glSub_N_N(s.shadeStep, s.shadeFeather), NL), s.shadeFeather)),
                    float_N(0.0),
                    float_N(1.0)
                )
            )
        ...
        glSet_V3_V3(
            ...
            mix_V3_V3_N(
                ...
                diffuse,
                clamp_N_N_N(
                    glAdd_N_N(float_N(1.0), glDiv_N_N(glSub_N_N(glSub_N_N(s.baseStep, s.baseFeather), NL), s.baseFeather)),
                    float_N(0.0),
                    float_N(1.0)
                )
            )
        ...
        glSet_N_N(specularMask, step_N_N(specularWeight, NH))
        let specular: Vec3Data = vec3()
        glSet_V3_V3(specular, glMul_V3_N(s.specular.xyz, specularMask))
        let finalColor: Vec3Data = vec3()
        glSet_V3_V3(finalColor, glMul_V3_V3(lightColor, glAdd_V3_V3(diffuse, specular)))
        glAddSet_V3_V3(finalColor, s.emissive)
        {
            ...
            glSet_N_N(
                cosAngle,
                clamp_N_N_N(glSub_N_N(float_N(1.0), dot_V3_V3(N, this.uniformData.cc_mainLitDir.xyz)), float_N(0.0), float_N(1.0))
            )
            let projWorldPos: Vec3Data = vec3()
            glSet_V3_V3(
                projWorldPos,
                glAdd_V3_V3(
                    this.varyingData.v_shadowPos.xyz,
                    glMul_N_V3(glMul_N_N(cosAngle, float_N(this.uniformData.cc_shadowLPNNInfo.z)), N)
                )
            )
            let pos: Vec4Data = vec4()
            glSet_V4_V4(pos, vec4_V3_N(projWorldPos.xyz, float_N(this.varyingData.v_shadowPos.w)))
        ...
        return vec4_V3_N(finalColor, float_N(s.baseColor.w))
    }
