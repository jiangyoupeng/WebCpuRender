...
export class Impl_689adc62eaf756ec839e1afce636bb32 extends FragShaderHandle {
    ...
    frag(): Vec4Data {
        ...
        glMulSet_V4_V4(o, texture2D_N_V2(this.uniformData.mainTexture, this.varyingData.v_uv))
        glSet_V4_V4(
            o,
            vec4_V3_N(
                mix_V3_V3_N(
