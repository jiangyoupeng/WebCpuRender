...
export class Impl_76d7f4e8e8d6ca6f170b5836b201e4bb extends VertShaderHandle {
    ...
    vert(): Vec4Data {
        ...
        let worldPos: Vec4Data = vec4()
        glSet_V4_V4(worldPos, glMul_M4_V4(matWorld, In.position))
        let clipPos: Vec4Data = vec4()
        glSet_V4_V4(clipPos, glMul_M4_V4(this.uniformData.cc_matLightViewProj, worldPos))
        glSet_V2_V2(
        ...
        glSet_V2_V2(this.varyingData.v_clip_depth, clipPos.zw)
        return clipPos
    }
    main(): void {
