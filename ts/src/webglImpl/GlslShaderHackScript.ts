...
export let glslShaderHackScript: Map<string, string> = new Map([
    [
        `9477948e37c1f312dba626891d6c76ca`,
        `
        ...
        varying vec4 v_colorLogTest;
          ...
          mat4 skinMatrix () {
            ...
            vec4 testPoint = vec4(0, 0, 0.5, 0.5);
            vec4 testWeights = vec4(0.5, 0.5, 0, 0);
            mat4 testM = getJointMatrix(testPoint.x) * testWeights.x
            + getJointMatrix(testPoint.y) * testWeights.y
            + getJointMatrix(testPoint.z) * testWeights.z
            + getJointMatrix(testPoint.w) * testWeights.w;
            v_colorLogTest = testM[1];
    ...
    [
        `89ba5ffedfbf0d9d0d53617f546b82cd`,
        `
        #define BASE_COLOR_MAP_AS_SHADE_MAP_2 1
        #define BASE_COLOR_MAP_AS_SHADE_MAP_1 1
        #define SHADE_MAP_1_AS_SHADE_MAP_2 0
